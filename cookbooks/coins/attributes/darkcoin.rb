...
default[:coins][:darkcoin][:rpc_port] = '9998'
default[:coins][:darkcoin][:rpc_allow_net] = '127.0.0.1'
default[:coins][:darkcoin][:wallet_location] = 'S3'
default[:coins][:darkcoin][:wallet_s3_bucket] = ''
default[:coins][:darkcoin][:wallet_s3_key] = ''
default[:coins][:darkcoin][:wallet_s3_secret] = ''
